<br>
<div>
    <input type="radio" id="all_weight" name="all_type" value="all_weight" style="width: 20px !important;" checked>
    ...
    $( document ).ready(function() {
        ...
        $('#all_weight').click(function() {
            if($('#all_weight').is(':checked')) { 
                // console.log($(document).find('select.payment_type'));
                $(document).find('select.payment_type').val(1);
                calculator();
